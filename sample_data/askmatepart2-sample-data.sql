...
INSERT INTO question VALUES (0, '2017-04-28 08:29:00', 29, 7, 'How to make lists in Python?', 'I am totally new to this, any hints?', 'uploads/translate.png', 0);
...
Thanks.', 'uploads/birds_rainbow-lorakeets.png', 1);

INSERT INTO question VALUES (5, '2018-04-28 08:29:00', 3, 7, 'How to keep the header static, always on top while scrolling?', 'How would I go about keeping my header from scrolling with the rest of the page? I thought about utilizing frame-sets and iframes, just wondering if there is a easier and more user friendly way, what would be the best-practice for doing this?', 'uploads/kwiatki1.jfif', 1);
...
Any ideas?', 'uploads/magnolia.jfif', 1);
...
', 'uploads/narcyz.jfif', 1);


SELECT pg_catalog.setval('question_id_seq', 7, true);


INSERT INTO answer VALUES (1, '2017-04-28 16:49:00', 4, 1, 'You need to use brackets: my_list = []', 'uploads/bananas.jpg', 0);
INSERT INTO answer VALUES (2, '2017-04-25 14:42:00', 35, 1, 'Look it up in the Python docs', 'uploads/strawberries.jpg', 0);
INSERT INTO answer VALUES (3, '2017-09-01 14:42:00', 1, 3, 'you could start them in the micro wave for 5 or ten minutes then just through them in the smoker to finish, you could wrap them foil if you don''t want the smoke on them, but I don''t know why you wouldn''t good luck', 'https://www.kasandbox.org/programming-images/landscapes/mountain_matterhorn.png', 0);
INSERT INTO answer VALUES (4, '2017-09-01 20:24:00', 2, 3, 'Rub them down with butter, salt/pepper them, wrap them completely in foil and throw them on the smoker. You''re probably looking at 4 hours of cook time at 250 degree smoker temp.', NULL, 0);
...
That said, the Selectors Level 4 Working Draft includes a :has() pseudo-class that will provide this capability. It will be similar to the jQuery implementation.', 'https://1.bp.blogspot.com/-kGcxwneCgiM/Xseae3AuoYI/AAAAAAAAcHc/nJBKSBJXYKw2ZGGwj46OZ1cTWrXPlCZmwCLcBGAsYHQ/s1600/IMG_3162.jpg', 1);
...
Finally, click Commit new file', NULL, 1);
INSERT INTO answer VALUES (10, '2020-04-15 14:42:00', 5, 7, 'Git doesn''t store empty folders. Just make sure there''s a file in the folder like doc/foo.txt and run git add doc or git add doc/foo.txt, and the folder will be added to your local repository once you''ve committed (and appear on GitHub once you''ve pushed it).', NULL, 1);
...
INSERT INTO comment VALUES (1, 0, NULL, 0, 'Please clarify the question as it is too vague!', '2017-05-01 05:49:00');
INSERT INTO comment VALUES (2, NULL, 1, 0, 'I think you could use my_list = list() as well.', '2017-05-02 16:55:00');
INSERT INTO comment VALUES (3, NULL, 4, 0, 'If you wrap them in foil, then what''s the point in putting them in the smoker?', '2017-09-02 16:55:00');
INSERT INTO comment VALUES (4, NULL, 6, 0, 'Wow, i really cannot bear to do that. I tried and it is so torturing to see my son really crying and i will quickly carry him in my arms again. Sigh, i know this is bad, but got no choice, heart too soft. I will try see if got other methods not.', '2017-10-02 16:55:00');
...
INSERT INTO comment VALUES (12, 7, NULL, 1, 'I know this is very old question but still might save time for someone The below link is to an answer mentioning how to create folder on Github website itself.', '2018-02-21 05:49:00');
INSERT INTO comment VALUES (13, NULL,10, 1, 'If you set up your repository on github the way the site suggests, it''d be "git push origin master" - origin being the default name for the remote repository and master being the default name of your branch.', '2018-03-01 05:49:00');
